...
helm upgrade --install kagent oci://ghcr.io/kagent-dev/kagent/helm/kagent \
  --namespace kagent \
  -f /Users/admin/Documents/kodekloud/kagent/kagent-lab/060-010/support-code/01-values-min.yaml \
...
kubectl apply -f /Users/admin/Documents/kodekloud/kagent/kagent-lab/060-010/support-code/cloudwatch-mcp-server.yaml
...
bash /Users/admin/Documents/kodekloud/kagent/kagent-lab/060-010/support-code/setup-cloudwatch-logs.sh
```
...
```bash
# Port forward to access Kagent UI
kubectl port-forward -n kagent svc/kagent-ui 8080:80

# Open browser to http://localhost:8080
echo "Kagent UI available at: http://localhost:8080"
```
